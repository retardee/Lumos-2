...
/proc/tg_ui_icon_to_cit_ui(ui_style)
	switch(ui_style)
		if('icons/mob/screen_plasmafire.dmi')
			return 'modular_lumos/icons/ui/screen_plasmafire.dmi'
		if('icons/mob/screen_slimecore.dmi')
			return 'modular_lumos/icons/ui/screen_slimecore.dmi'
		if('icons/mob/screen_operative.dmi')
			return 'modular_lumos/icons/ui/screen_operative.dmi'
		if('icons/mob/screen_clockwork.dmi')
			return 'modular_lumos/icons/ui/screen_clockwork.dmi'
		if('modular_lumos/icons/mob/screen_liteweb.dmi')
			return 'modular_lumos/icons/mob/screen_liteweb.dmi'
		else
			return 'modular_lumos/icons/ui/screen_midnight.dmi'
