...
/datum/sprite_accessory/snouts/mam_snouts/synthliz
	...
	icon = 'modular_lumos/icons/mob/synthliz_snouts.dmi'
	color_src = MUTCOLORS
...
/datum/sprite_accessory/mam_body_markings/synthliz/synthliz_pecs
	icon = 'modular_lumos/icons/mob/synthliz_body_markings.dmi'
...
/datum/sprite_accessory/tails/mam_tails/synthliz
	recommended_species = list("synthliz")
	icon = 'modular_lumos/icons/mob/synthliz_tails.dmi'
	color_src = MUTCOLORS
...
/datum/sprite_accessory/antenna/synthliz
	recommended_species = list("synthliz")
	icon = 'modular_lumos/icons/mob/synthliz_antennas.dmi'
	color_src = MUTCOLORS
