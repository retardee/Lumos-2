...
/obj/item/gun/energy/e_gun/advtaser
	...
	icon_state = "advtaser"
	ammo_type = list(/obj/item/ammo_casing/energy/disabler, /obj/item/ammo_casing/energy/electrode/security = TRUE) // Lumos change FALSE to TRUE - Fear the wrath of the golden bolt
	ammo_x_offset = 2
