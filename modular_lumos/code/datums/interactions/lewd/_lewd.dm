...
/mob/living/proc/cum(mob/living/partner, target_orifice)
	...
	if(gender == MALE)
		playlewdinteractionsound(loc, pick('modular_lumos/sound/interactions/final_m1.ogg',
							'modular_lumos/sound/interactions/final_m2.ogg',
							'modular_lumos/sound/interactions/final_m3.ogg',
							'modular_lumos/sound/interactions/final_m4.ogg',
							'modular_lumos/sound/interactions/final_m5.ogg'), 90, 1, 0)
	else if(gender == FEMALE)
		playlewdinteractionsound(loc, pick('modular_lumos/sound/interactions/final_f1.ogg',
							'modular_lumos/sound/interactions/final_f2.ogg',
							'modular_lumos/sound/interactions/final_f3.ogg'), 70, 1, 0)
	else
		playlewdinteractionsound(loc, pick('modular_lumos/sound/interactions/final_f1.ogg',
							'modular_lumos/sound/interactions/final_f2.ogg',
							'modular_lumos/sound/interactions/final_f3.ogg'), 70, 1, 0)
...
/mob/living/proc/do_oral(mob/living/partner, var/fucktarget = "penis")
	...
	playlewdinteractionsound(get_turf(src), pick('modular_lumos/sound/interactions/bj1.ogg',
									'modular_lumos/sound/interactions/bj2.ogg',
									'modular_lumos/sound/interactions/bj3.ogg',
									'modular_lumos/sound/interactions/bj4.ogg',
									'modular_lumos/sound/interactions/bj5.ogg',
									'modular_lumos/sound/interactions/bj6.ogg',
									'modular_lumos/sound/interactions/bj7.ogg',
									'modular_lumos/sound/interactions/bj8.ogg',
									'modular_lumos/sound/interactions/bj9.ogg',
									'modular_lumos/sound/interactions/bj10.ogg',
									'modular_lumos/sound/interactions/bj11.ogg'), 50, 1, -1)
...
/mob/living/proc/do_facefuck(mob/living/partner, var/fucktarget = "penis")
	...
	playlewdinteractionsound(loc, pick('modular_lumos/sound/interactions/oral1.ogg',
						'modular_lumos/sound/interactions/oral2.ogg'), 70, 1, -1)
	visible_message(message = "<span class='lewd'><b>\The [src]</b> [message]</span>", ignored_mobs = get_unconsenting())
...
/mob/living/proc/thigh_smother(mob/living/partner, var/fucktarget = "penis")
	...
	var/file = pick('modular_lumos/sound/interactions/bj10.ogg',
					'modular_lumos/sound/interactions/bj3.ogg',
					'modular_lumos/sound/interactions/foot_wet1.ogg',
					'modular_lumos/sound/interactions/foot_dry3.ogg')
...
/mob/living/proc/nut_face(var/mob/living/partner)
	...
	/*playlewdinteractionsound(loc, pick('modular_lumos/sound/interactions/nuts1.ogg',
						'modular_lumos/sound/interactions/nuts2.ogg',
						'modular_lumos/sound/interactions/nuts3.ogg',
						'modular_lumos/sound/interactions/nuts4.ogg'), 70, 1, -1)*/ //These files don't even exist but nobody noticed because double-quotes were used instead of single.
	visible_message(message = "<span class='lewd'><b>\The [src]</b> [message]</span>", ignored_mobs = get_unconsenting())
...
/mob/living/proc/do_anal(mob/living/partner)
	...
	playlewdinteractionsound(loc, pick('modular_lumos/sound/interactions/bang1.ogg',
						'modular_lumos/sound/interactions/bang2.ogg',
						'modular_lumos/sound/interactions/bang3.ogg'), 70, 1, -1)
	visible_message(message = "<span class='lewd'><b>\The [src]</b> [message]</span>", ignored_mobs = get_unconsenting())
...
/mob/living/proc/do_vaginal(mob/living/partner)
	...
	playlewdinteractionsound(loc, pick('modular_lumos/sound/interactions/champ1.ogg',
						'modular_lumos/sound/interactions/champ2.ogg'), 50, 1, -1)
	visible_message(message = "<span class='lewd'><b>\The [src]</b> [message]</span>", ignored_mobs = get_unconsenting())
...
/mob/living/proc/do_tribadism(mob/living/partner)
	...
	playlewdinteractionsound(loc, pick('modular_lumos/sound/interactions/squelch1.ogg',
						'modular_lumos/sound/interactions/squelch2.ogg',
						'modular_lumos/sound/interactions/squelch3.ogg'), 70, 1, -1)
	visible_message(message = "<span class='lewd'><b>\The [src]</b> [message]</span>", ignored_mobs = get_unconsenting())
	partner.handle_post_sex(NORMAL_LUST, CUM_TARGET_VAGINA, src)
	handle_post_sex(NORMAL_LUST, null, partner)
...
/mob/living/proc/do_fingering(mob/living/partner)
	...
	playlewdinteractionsound(loc, 'modular_lumos/sound/interactions/champ_fingering.ogg', 50, 1, -1)
	partner.handle_post_sex(NORMAL_LUST, null, src)
...
/mob/living/proc/do_handjob(mob/living/partner)
	...
	playlewdinteractionsound(src, pick('modular_lumos/sound/interactions/bang1.ogg',
						'modular_lumos/sound/interactions/bang2.ogg',
						'modular_lumos/sound/interactions/bang3.ogg'), 70, 1, -1)
	visible_message(message = "<span class='lewd'><b>\The [src]</b> [message]</span>", ignored_mobs = get_unconsenting())
...
/mob/living/proc/do_grindface(mob/living/partner)
	...
	playlewdinteractionsound(loc, pick('modular_lumos/sound/interactions/foot_dry1.ogg',
						'modular_lumos/sound/interactions/foot_dry2.ogg',
						'modular_lumos/sound/interactions/foot_dry3.ogg',
						'modular_lumos/sound/interactions/foot_dry4.ogg'), 70, 1, -1)
	visible_message(message = "<span class='lewd'><b>\The [src]</b> [message]</span>", ignored_mobs = get_unconsenting())
...
/mob/living/proc/do_grindmouth(mob/living/partner)
	...
	playlewdinteractionsound(loc, pick('modular_lumos/sound/interactions/foot_wet1.ogg',
						'modular_lumos/sound/interactions/foot_wet2.ogg',
						'modular_lumos/sound/interactions/foot_wet3.ogg'), 70, 1, -1)
	visible_message(message = "<span class='lewd'><b>\The [src]</b> [message]</span>", ignored_mobs = get_unconsenting())
	partner.handle_post_sex(LOW_LUST, null, src)
...
/mob/living/proc/do_footfuck(mob/living/partner)
	...
	playlewdinteractionsound(loc, pick('modular_lumos/sound/interactions/foot_dry1.ogg',
						'modular_lumos/sound/interactions/foot_dry3.ogg',
						'modular_lumos/sound/interactions/foot_wet1.ogg',
						'modular_lumos/sound/interactions/foot_wet2.ogg'), 70, 1, -1)
	visible_message(message = "<span class='lewd'><b>\The [src]</b> [message]</span>", ignored_mobs = get_unconsenting())
