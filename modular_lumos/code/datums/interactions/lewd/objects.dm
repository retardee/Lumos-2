...
/obj/item/dildo/attack(mob/living/carbon/human/M, mob/living/carbon/human/user)
	...
	if(message)
		...
		playsound(loc, pick('modular_lumos/sound/interactions/bang4.ogg',
							'modular_lumos/sound/interactions/bang5.ogg',
							'modular_lumos/sound/interactions/bang6.ogg'), 70, 1, -1)
