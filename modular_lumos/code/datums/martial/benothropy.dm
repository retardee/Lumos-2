...
/obj/effect/proc_holder/spell/targeted/shapeshift/benothropy
	...
	invocation = "SSSSS!"
	action_icon = 'modular_lumos/icons/obj/actions_spells.dmi'
...
/obj/effect/proc_holder/spell/targeted/shapeshift/benothropy/cast(list/targets,mob/user = usr)
	if(!isxenoperson(user) && !isalien(user))
		...
		return
	playsound(get_turf(user), 'modular_lumos/sound/effects/transformation_hiss.ogg', 50, 1, -1)
...
/obj/item/xenothropy
	...
	icon = 'modular_lumos/icons/obj/library.dmi'
