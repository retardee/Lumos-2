...
/obj/item/reagent_containers/food/snacks/fish_bones
	...
	icon = 'modular_lumos/icons/obj/fishing/seafood.dmi'
	icon_state = "bone"
...
/obj/item/reagent_containers/food/snacks/asteroid_worm_raw
	name = "despined asteroid worm"
	desc = "Raw asteroid worm is actually considered a delicacy to Varyx, if the smell already didn't put you off."
	icon = 'modular_lumos/icons/obj/fishing/seafood.dmi'
...
/obj/item/reagent_containers/food/snacks/space_eel
	...
	list_reagents = list(/datum/reagent/consumable/sodiumchloride = 5, /datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/nutriment/vitamin = 2)
	tastes = list("sand" = 15, "salt" = 3, "sadness" = 3)
	foodtype = MEAT
