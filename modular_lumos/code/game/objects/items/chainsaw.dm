...
/obj/item/chainsaw/energy
	...
	lefthand_file = 'modular_lumos/icons/mob/inhands/weapons/chainsaw_lefthand.dmi'
	righthand_file = 'modular_lumos/icons/mob/inhands/weapons/chainsaw_righthand.dmi'
	force_on = 40
	...
	var/onsound
	var/offsound
	onsound = 'modular_lumos/sound/weapons/echainsawon.ogg'
	offsound = 'modular_lumos/sound/weapons/echainsawoff.ogg'
	on = FALSE
	var/brightness_on = 3
...
/obj/item/chainsaw/energy/attack_self(mob/user)
	...
	if(on)
		hitsound = pick('modular_lumos/sound/weapons/echainsawhit1.ogg','modular_lumos/sound/weapons/echainsawhit2.ogg')
	else
		hitsound = "swing_hit"
