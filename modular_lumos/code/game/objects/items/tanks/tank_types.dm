...
/obj/item/tank/internals/generic
	...
	icon = 'modular_lumos/icons/obj/tank.dmi'
	icon_state = "generic"
	lefthand_file = 'modular_lumos/icons/mob/inhands/equipment/tanks_lefthand.dmi'
	righthand_file = 'modular_lumos/icons/mob/inhands/equipment/tanks_righthand.dmi'
