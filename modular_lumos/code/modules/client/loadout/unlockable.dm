...
/datum/gear/unlockable/janitor
	...
	description = "Clean 100 messes with a mop to unlock this. It has a warning sign on it!"
...
/datum/gear/unlockable/cook
	name = "Cook Bedsheet"
	description = "Cook 250 items using the microwave to unlock this. It has a microwave on it!"
