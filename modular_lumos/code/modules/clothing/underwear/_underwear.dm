...
/obj/item/clothing/underwear
	...
	icon = 'modular_lumos/icons/mob/clothing/underwear.dmi' //if someone is willing to make proper inventory sprites that'd be very cash money
	mob_overlay_icon = 'modular_lumos/icons/mob/clothing/underwear.dmi'
	anthro_mob_worn_overlay = 'modular_lumos/icons/mob/clothing/underwear_digi.dmi'
