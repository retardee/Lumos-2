...
/area/eventmap
	...
	icon = 'modular_lumos/code/modules/eventmaps/Spookystation/areas.dmi' //It unsets the icon. don't make a err icon.
...
/turf/closed/indestructible/spookytime/matrixblocker //Two times the reference power.
	name = "matrix"
	icon = 'modular_lumos/code/modules/eventmaps/Spookystation/iconfile32.dmi'
	icon_state = "matrix"
...
/turf/open/floor/spooktime/spooktimegrass
	...
	icon_state = "grass_1"
	icon = 'modular_lumos/code/modules/eventmaps/Spookystation/iconfile32.dmi' //32x32 iconfile, sry we had different sizes.
...
/datum/looping_sound/active_outside_longrain
	mid_sounds = list('modular_lumos/code/modules/eventmaps/Spookystation/outsideloop1.ogg'=1,
					  'modular_lumos/code/modules/eventmaps/Spookystation/outsideloop2.ogg'=1)
...
/datum/looping_sound/active_inside_longrain
	mid_sounds = list('modular_lumos/code/modules/eventmaps/Spookystation/insideloop1.ogg'=1,
					'modular_lumos/code/modules/eventmaps/Spookystation/insideloop2.ogg'=1,
					'modular_lumos/code/modules/eventmaps/Spookystation/insideloop3.ogg'=1,
					'modular_lumos/code/modules/eventmaps/Spookystation/insideloop4.ogg'=1)
	mid_length = 5.1 //AAAAAAAAAAAAAAAAAAAAAAA
	volume = 60

/datum/looping_sound/active_mountain_longrain
	mid_sounds = list('modular_lumos/code/modules/eventmaps/Spookystation/basecaveloop.ogg'=1)
...
/obj/machinery/grandfatherclock
	...
	icon = 'modular_lumos/code/modules/eventmaps/Spookystation/clock32x49.dmi'
...
/obj/machinery/grandfatherclock/proc/doodad_clock_ticker() //We basically throttle the rest of this machine here.
	...
	if(ticktock) //If we are true
		playsound(src.loc, 'modular_lumos/code/modules/eventmaps/Spookystation/Tock.ogg', 100,0)
		icon_state = "grandfathermk4right"
		flick("tick", src)
		ticktock = 0 //Play this noise set to false
	else
		playsound(src.loc, 'modular_lumos/code/modules/eventmaps/Spookystation/Tick.ogg', 100,0)
		flick("tock", src)
...
/obj/machinery/grandfatherclock/proc/dyndial_cycle()
	...
	if(playchime && hour == 0)
		playsound(src.loc, 'modular_lumos/code/modules/eventmaps/Spookystation/midnightchime.ogg', 100, 0)
		playchime = 0
...
/obj/structure/flora/grass/spookytime
	icon = 'modular_lumos/code/modules/eventmaps/Spookystation/iconfile32.dmi' //32x32 iconfile
...
/obj/structure/flora/tree/spookytime
	...
	icon = 'modular_lumos/code/modules/eventmaps/Spookystation/iconfile64.dmi' //64x64 iconfile
...
/obj/structure/flora/tree/spookytimexl
	...
	icon = 'modular_lumos/code/modules/eventmaps/Spookystation/talltree128.dmi'
	icon_state = "tree_1"
	log_amount = 12
	density = 1
	obj_integrity = 200
