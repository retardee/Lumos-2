...
/datum/plant_gene/trait/plant_laughter
	...
	var/list/sounds = list('modular_lumos/sound/effects/SitcomLaugh1.ogg', 'modular_lumos/sound/effects/SitcomLaugh2.ogg', 'modular_lumos/sound/effects/SitcomLaugh3.ogg')
