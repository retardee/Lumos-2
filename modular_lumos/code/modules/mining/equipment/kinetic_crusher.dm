...
/obj/item/kinetic_crusher/premiumcrusher
	...
	lefthand_file = 'modular_lumos/icons/mob/inhands/weapons/hammerspc_lefthand.dmi'
	righthand_file = 'modular_lumos/icons/mob/inhands/weapons/hammerspc_righthand.dmi'
...
/obj/item/crusher_trophy/blaster_tubes/impskull/on_projectile_fire(obj/item/projectile/destabilizer/marker, mob/living/user)
	...
	marker.damage = bonus_value
	marker.nodamage = FALSE
	playsound(user.loc, 'modular_lumos/sound/misc/impranged.wav', 50, 0)
...
/obj/item/melee/zweihander
	...
	hitsound = 'modular_lumos/sound/weapons/zweihanderslice.ogg'
...
/obj/item/crusher_trophy/dark_energy/on_mark_detonation(mob/living/target, mob/living/user)
	...
	if(!T) //the final dash turf was out of range - we settle for the target turf instead
		T = chargeturf
	playsound(user, pick('modular_lumos/sound/sif/whoosh1.ogg', 'modular_lumos/sound/sif/whoosh2.ogg', 'modular_lumos/sound/sif/whoosh3.ogg'), 300, 1)
