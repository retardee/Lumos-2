...
/datum/emote/living/scream/run_emote(mob/living/user, params) //I can't not port this shit, come on.
	...
	if(!user.is_muzzled() && !miming)
		...
		if(issilicon(user))
			sound = 'modular_lumos/sound/voice/scream_silicon.ogg'
			if(iscyborg(user))
				...
				S.cell.use(200)
		if(ismonkey(user))
			sound = 'modular_lumos/sound/voice/scream_monkey.ogg'
		if(istype(user, /mob/living/simple_animal/hostile/gorilla))
			sound = 'sound/creatures/gorilla.ogg'
		if(ishuman(user))
			user.adjustOxyLoss(5)
			sound = pick('modular_lumos/sound/voice/scream_m1.ogg', 'modular_lumos/sound/voice/scream_m2.ogg')
			if(user.gender == FEMALE)
				sound = pick('modular_lumos/sound/voice/scream_f1.ogg', 'modular_lumos/sound/voice/scream_f2.ogg')
			if(is_species(user, /datum/species/jelly))
				if(user.gender == FEMALE)
					sound = pick('modular_lumos/sound/voice/scream_jelly_f1.ogg', 'modular_lumos/sound/voice/scream_jelly_f2.ogg')
				else
					sound = pick('modular_lumos/sound/voice/scream_jelly_m1.ogg', 'modular_lumos/sound/voice/scream_jelly_m2.ogg')
			...
			if(is_species(user, /datum/species/lizard))
				sound = 'modular_lumos/sound/voice/scream_lizard.ogg'
			if(is_species(user, /datum/species/skeleton))
				sound = 'modular_lumos/sound/voice/scream_skeleton.ogg'
			if (is_species(user, /datum/species/fly) || is_species(user, /datum/species/insect))
				sound = 'modular_lumos/sound/voice/scream_moth.ogg'
		if(isalien(user))
...
/datum/emote/living/snap/run_emote(mob/living/user, params)
	...
	if(user.nextsoundemote >= world.time)
		return
	user.nextsoundemote = world.time + 7
	playsound(user, 'modular_lumos/sound/voice/snap.ogg', 50, 1, -1)
...
/datum/emote/living/snap2/run_emote(mob/living/user, params)
	...
	if(user.nextsoundemote >= world.time)
		return
	user.nextsoundemote = world.time + 7
	playsound(user, 'modular_lumos/sound/voice/snap2.ogg', 50, 1, -1)
...
/datum/emote/living/snap3/run_emote(mob/living/user, params)
	...
	if(user.nextsoundemote >= world.time)
		return
	user.nextsoundemote = world.time + 7
	playsound(user, 'modular_lumos/sound/voice/snap3.ogg', 50, 1, -1)
...
/datum/emote/living/awoo/run_emote(mob/living/user, params)
	...
	if(user.nextsoundemote >= world.time)
		return
	user.nextsoundemote = world.time + 7
	playsound(user, 'modular_lumos/sound/voice/awoo.ogg', 50, 1, -1)
...
/datum/emote/living/hiss/run_emote(mob/living/user, params)
	...
	if(user.nextsoundemote >= world.time)
		return
	user.nextsoundemote = world.time + 7
	playsound(user, 'modular_lumos/sound/voice/hiss.ogg', 50, 1, -1)
...
/datum/emote/living/meow/run_emote(mob/living/user, params)
	...
	if(user.nextsoundemote >= world.time)
		return
	user.nextsoundemote = world.time + 7
	playsound(user, 'modular_lumos/sound/voice/meow1.ogg', 50, 1, -1)
...
/datum/emote/living/purr/run_emote(mob/living/user, params)
	...
	if(user.nextsoundemote >= world.time)
		return
	user.nextsoundemote = world.time + 7
	playsound(user, 'modular_lumos/sound/voice/purr.ogg', 50, 1, -1)
...
/datum/emote/living/nya/run_emote(mob/living/user, params)
	...
	if(user.nextsoundemote >= world.time)
		return
	user.nextsoundemote = world.time + 7
	playsound(user, 'modular_lumos/sound/voice/nya.ogg', 50, 1, -1)
...
/datum/emote/living/weh/run_emote(mob/living/user, params)
	...
	if(user.nextsoundemote >= world.time)
		return
	user.nextsoundemote = world.time + 7
	playsound(user, 'modular_lumos/sound/voice/weh.ogg', 50, 1, -1)
...
/datum/emote/living/mothsqueak/run_emote(mob/living/user, params)
	...
	if(user.nextsoundemote >= world.time)
		return
	user.nextsoundemote = world.time + 7
	playsound(user, 'modular_lumos/sound/voice/mothsqueak.ogg', 50, 1, -1)
...
/datum/emote/living/merp/run_emote(mob/living/user, params)
	...
	if(user.nextsoundemote >= world.time)
		return
	user.nextsoundemote = world.time + 7
	playsound(user, 'modular_lumos/sound/voice/merp.ogg', 50, 1, -1)
...
/datum/emote/living/bark/run_emote(mob/living/user, params)
	...
	if(user.nextsoundemote >= world.time)
		return
	user.nextsoundemote = world.time + 7
	var/sound = pick('modular_lumos/sound/voice/bark1.ogg', 'modular_lumos/sound/voice/bark2.ogg')
...
/datum/emote/living/pain/run_emote(mob/living/user, params)
	...
	var/sound
	if(user.gender == MALE)
		sound = pick('modular_lumos/sound/voice/human_male_pain_1.ogg', 'modular_lumos/sound/voice/human_male_pain_2.ogg', 'modular_lumos/sound/voice/human_male_pain_3.ogg', 'modular_lumos/sound/voice/human_male_pain_rare.ogg', 'modular_lumos/sound/voice/human_male_scream_1.ogg', 'modular_lumos/sound/voice/human_male_scream_2.ogg', 'modular_lumos/sound/voice/human_male_scream_3.ogg', 'modular_lumos/sound/voice/human_male_scream_4.ogg')
	else
		sound = pick('modular_lumos/sound/voice/human_female_pain_1.ogg', 'modular_lumos/sound/voice/human_female_pain_2.ogg', 'modular_lumos/sound/voice/human_female_pain_3.ogg', 'modular_lumos/sound/voice/human_female_scream_2.ogg', 'modular_lumos/sound/voice/human_female_scream_3.ogg', 'modular_lumos/sound/voice/human_female_scream_4.ogg')
...
/datum/emote/living/clap1/run_emote(mob/living/user, params)
	if(!(. = ..()))
		return
	playsound(user, 'modular_lumos/sound/voice/clap.ogg', 50, 1, -1)
