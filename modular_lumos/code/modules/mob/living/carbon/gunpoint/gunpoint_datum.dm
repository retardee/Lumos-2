/obj/effect/overlay/gunpoint_effect
	icon = 'modular_lumos/icons/mob/targeted.dmi'
	icon_state = "locking"
	layer = FLY_LAYER
	plane = GAME_PLANE
...
/datum/gunpoint
	...
	var/static/radio_forbid = image(icon = 'modular_lumos/icons/mob/radial_gunpoint.dmi', icon_state = "radial_radio_forbid")
	var/static/radio_allow = image(icon = 'modular_lumos/icons/mob/radial_gunpoint.dmi', icon_state = "radial_radio")
	var/static/use_forbid = image(icon = 'modular_lumos/icons/mob/radial_gunpoint.dmi', icon_state = "radial_use_forbid")
	var/static/use_allow = image(icon = 'modular_lumos/icons/mob/radial_gunpoint.dmi', icon_state = "radial_use")
	var/static/move_forbid = image(icon = 'modular_lumos/icons/mob/radial_gunpoint.dmi', icon_state = "radial_move_forbid")
	var/static/move_allow = image(icon = 'modular_lumos/icons/mob/radial_gunpoint.dmi', icon_state = "radial_move")
...
/datum/gunpoint/proc/LockOn()
	if(src) //if we're not present then locking on failed and this datum is deleted
		...
		playsound(get_turf(source), 'modular_lumos/sound/effects/targeton.ogg', 50,1)
...
/datum/gunpoint/proc/ClickDestroy()
	if(locked)
		playsound(get_turf(source), 'modular_lumos/sound/effects/targetoff.ogg', 50,1)
	Destroy()
