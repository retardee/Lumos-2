...
/mob/living/simple_animal/hostile/megafauna/sif
	...
	attack_sound = 'modular_lumos/sound/sif/sif_slash.ogg'
	icon_state = "Great_Brown_Wolf"
	icon_living = "Great_Brown_Wolf"
	icon_dead = ""
	friendly_verb_continuous = "stares down"
	friendly_verb_simple = "stare down"
	icon = 'modular_lumos/icons/mob/lavaland/sif.dmi'
	...
	deathsound = 'modular_lumos/sound/sif/death_howl.ogg'
...
/obj/structure/sword/sif
	...
	max_integrity = 10000
	anchored = TRUE
	icon = 'modular_lumos/icons/mob/lavaland/sif_sword.dmi'
...
/mob/living/simple_animal/hostile/megafauna/sif/proc/angered()
	...
	playsound(src, 'modular_lumos/sound/sif/howl.ogg', 100, 1)
			...
			if(isturf(src.loc) || isobj(src.loc) && src.loc.density)
				...
				for(var/mob/living/LM in view(1, src))
					if(!(LM in hit_things))
						LM.Stun(30, TRUE)
						hit_things += LM
				playsound(src, pick('modular_lumos/sound/sif/whoosh1.ogg', 'modular_lumos/sound/sif/whoosh2.ogg', 'modular_lumos/sound/sif/whoosh3.ogg'), 300, 1)
				playsound(src, 'modular_lumos/sound/sif/blade_spin.ogg', 400, 1)
				if(angered)
					src.speed = 6
					src.move_to_delay = 2
...
/mob/living/simple_animal/hostile/megafauna/sif/Bump(atom/A)
	if(charging == TRUE)
		...
		if(isliving(A))
			...
			playsound(get_turf(L), 'modular_lumos/sound/sif/sif_stomp.ogg', 400, 1)
			shake_camera(L, 4, 3)
