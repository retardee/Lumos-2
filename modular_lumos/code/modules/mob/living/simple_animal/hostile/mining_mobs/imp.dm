...
/mob/living/simple_animal/hostile/asteroid/imp
	...
	icon = 'modular_lumos/icons/mob/lavaland/lavaland_monsters.dmi'
	icon_state = "imp"
	icon_living = "imp"
	icon_aggro = "imp"
	icon_dead = "imp_dead"
	...
	projectilesound = 'modular_lumos/sound/misc/impranged.wav'
	ranged = 1
	...
	attack_sound = 'modular_lumos/sound/misc/impattacks.wav'
	...
	death_sound = 'modular_lumos/sound/misc/impdies.wav'
...
/mob/living/simple_animal/hostile/asteroid/imp/attacked_by(obj/item/I, mob/living/user)
	. = ..()
	playsound(src, 'modular_lumos/sound/misc/impinjured.wav', rand(25,100), -1) //HURT ME PLENTY

/mob/living/simple_animal/hostile/asteroid/imp/bullet_act(obj/item/projectile/P)
	. = ..()
	playsound(src, 'modular_lumos/sound/misc/impinjured.wav', rand(25,100), -1)

/mob/living/simple_animal/hostile/asteroid/imp/Aggro()
	. = ..()
	playsound(src, pick('modular_lumos/sound/misc/impsight.wav', 'modular_lumos/sound/misc/impsight2.wav'), rand(50,75), -1)

/mob/living/simple_animal/hostile/asteroid/imp/LoseAggro()
	. = ..()
	playsound(src, pick('modular_lumos/sound/misc/impnearby.wav', 'modular_lumos/sound/misc/impnearby.wav'), rand(25, 60), -1)
...
/obj/item/projectile/magic/impfireball/on_hit(target)
	...
	if(iscarbon(target))
		...
		if(C.stat != DEAD && C.stat != UNCONSCIOUS)
			playsound(C, 'modular_lumos/sound/misc/doominjured.wav', 100, -1)
		else if(C.stat == DEAD)
			playsound(C, 'modular_lumos/sound/misc/doomdies.wav', 100, -1)
		else
			playsound(C, pick('modular_lumos/sound/misc/doomscream.wav', 'modular_lumos/sound/misc/doomscream2.wav'), 100, -1)
