/obj/item/origami
	...
	icon = 'modular_lumos/icons/obj/bureaucracy.dmi'
	icon_state = "scrap"
	throw_range = 1
	throw_speed = 1
	throwforce = 0
...
/obj/item/paper/AltClick(mob/living/carbon/user, obj/item/I)
	...
	var/list/radial_list = list(
		"Paper plane" = image(icon = 'modular_lumos/icons/obj/bureaucracy.dmi', icon_state = "paperplane"),
		"Paper crane" = image(icon = 'modular_lumos/icons/obj/bureaucracy.dmi', icon_state = "papercrane"),
		"Paper frog" = image(icon = 'modular_lumos/icons/obj/bureaucracy.dmi', icon_state = "paperfrog"),
		"Paper boat" = image(icon = 'modular_lumos/icons/obj/bureaucracy.dmi', icon_state = "paperboat")
	)
...
/proc/origami_nametotype(name)
	switch(name)
		if("Paper plane") return /obj/item/paperplane
