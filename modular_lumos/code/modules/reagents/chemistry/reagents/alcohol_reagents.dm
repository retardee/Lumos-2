...
/datum/reagent/consumable/ethanol/whiskeywarper/on_mob_life(mob/living/carbon/M)
	...
	if(warp >= 1 && canwarp == TRUE)
		...
		if(M.mind.assigned_role == "Clown")
			playsound(T,'modular_lumos/sound/effects/whiskeywarperhonk.ogg', 50, TRUE)
		else
			playsound(T,'modular_lumos/sound/effects/drinkwhistlewarp.ogg', 50, TRUE)
...
/datum/reagent/consumable/ethanol/bonezone/on_mob_life(mob/living/carbon/M)
	if(prob(8))
		playsound(M, 'modular_lumos/sound/effects/2spooky4me.ogg', 75, 1, -1)
		if(!isskeleton(M))
