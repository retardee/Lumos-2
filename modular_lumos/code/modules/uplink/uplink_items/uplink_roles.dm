...
/datum/uplink_item/role_restricted/syndieseeds
	...
	desc = "Though the existence of gatfruit in major quantities seems to elude us we have managed to genetically modify some plants through countless testing and some assistance from some Russian colleagues to give a similar effect. Comes with one packet of seeds!"
